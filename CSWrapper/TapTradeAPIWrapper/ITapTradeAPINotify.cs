...
public class ITapTradeAPINotify : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          TapTradeAPIWrapperPINVOKE.delete_ITapTradeAPINotify(swigCPtr);
        }
  ...
  public virtual void OnConnect(string HostAddress) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnConnect(swigCPtr, HostAddress);
  }

  public virtual void OnRspLogin(int errorCode, TapAPITradeLoginRspInfo loginRspInfo) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspLogin(swigCPtr, errorCode, TapAPITradeLoginRspInfo.getCPtr(loginRspInfo));
  }

  public virtual void OnRtnContactInfo(int errorCode, char isLast, string ContactInfo) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnContactInfo(swigCPtr, errorCode, isLast, ContactInfo);
  }

  public virtual void OnRspRequestVertificateCode(uint sessionID, int errorCode, TapAPIRequestVertificateCodeRsp rsp) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspRequestVertificateCode(swigCPtr, sessionID, errorCode, TapAPIRequestVertificateCodeRsp.getCPtr(rsp));
  }

  public virtual void OnExpriationDate(string date, int days) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnExpriationDate(swigCPtr, date, days);
  }

  public virtual void OnAPIReady(int errorCode) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnAPIReady(swigCPtr, errorCode);
  }

  public virtual void OnDisconnect(int reasonCode) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnDisconnect(swigCPtr, reasonCode);
  }

  public virtual void OnRspChangePassword(uint sessionID, int errorCode) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspChangePassword(swigCPtr, sessionID, errorCode);
  }

  public virtual void OnRspAuthPassword(uint sessionID, int errorCode) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspAuthPassword(swigCPtr, sessionID, errorCode);
  }

  public virtual void OnRspQryTradingDate(uint sessionID, int errorCode, TapAPITradingCalendarQryRsp info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryTradingDate(swigCPtr, sessionID, errorCode, TapAPITradingCalendarQryRsp.getCPtr(info));
  }

  public virtual void OnRspSetReservedInfo(uint sessionID, int errorCode, string info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspSetReservedInfo(swigCPtr, sessionID, errorCode, info);
  }

  public virtual void OnRspQryAccount(uint sessionID, uint errorCode, char isLast, TapAPIAccountInfo info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryAccount(swigCPtr, sessionID, errorCode, isLast, TapAPIAccountInfo.getCPtr(info));
  }

  public virtual void OnRspQryFund(uint sessionID, int errorCode, char isLast, TapAPIFundData info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryFund(swigCPtr, sessionID, errorCode, isLast, TapAPIFundData.getCPtr(info));
  }

  public virtual void OnRtnFund(TapAPIFundData info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnFund(swigCPtr, TapAPIFundData.getCPtr(info));
  }

  public virtual void OnRspQryExchange(uint sessionID, int errorCode, char isLast, TapAPIExchangeInfo info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryExchange(swigCPtr, sessionID, errorCode, isLast, TapAPIExchangeInfo.getCPtr(info));
  }

  public virtual void OnRspQryCommodity(uint sessionID, int errorCode, char isLast, TapAPICommodityInfo info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryCommodity(swigCPtr, sessionID, errorCode, isLast, TapAPICommodityInfo.getCPtr(info));
  }

  public virtual void OnRspQryContract(uint sessionID, int errorCode, char isLast, TapAPITradeContractInfo info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryContract(swigCPtr, sessionID, errorCode, isLast, TapAPITradeContractInfo.getCPtr(info));
  }

  public virtual void OnRtnContract(TapAPITradeContractInfo info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnContract(swigCPtr, TapAPITradeContractInfo.getCPtr(info));
  }

  public virtual void OnRspOrderAction(uint sessionID, int errorCode, TapAPIOrderActionRsp info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspOrderAction(swigCPtr, sessionID, errorCode, TapAPIOrderActionRsp.getCPtr(info));
  }

  public virtual void OnRtnOrder(TapAPIOrderInfoNotice info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnOrder(swigCPtr, TapAPIOrderInfoNotice.getCPtr(info));
  }

  public virtual void OnRspQryOrder(uint sessionID, int errorCode, char isLast, TapAPIOrderInfo info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryOrder(swigCPtr, sessionID, errorCode, isLast, TapAPIOrderInfo.getCPtr(info));
  }

  public virtual void OnRspQryOrderProcess(uint sessionID, int errorCode, char isLast, TapAPIOrderInfo info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryOrderProcess(swigCPtr, sessionID, errorCode, isLast, TapAPIOrderInfo.getCPtr(info));
  }

  public virtual void OnRspQryFill(uint sessionID, int errorCode, char isLast, TapAPIFillInfo info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryFill(swigCPtr, sessionID, errorCode, isLast, TapAPIFillInfo.getCPtr(info));
  }

  public virtual void OnRtnFill(TapAPIFillInfo info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnFill(swigCPtr, TapAPIFillInfo.getCPtr(info));
  }

  public virtual void OnRspQryPosition(uint sessionID, int errorCode, char isLast, TapAPIPositionInfo info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryPosition(swigCPtr, sessionID, errorCode, isLast, TapAPIPositionInfo.getCPtr(info));
  }

  public virtual void OnRtnPosition(TapAPIPositionInfo info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnPosition(swigCPtr, TapAPIPositionInfo.getCPtr(info));
  }

  public virtual void OnRspQryPositionSummary(uint sessionID, int errorCode, char isLast, TapAPIPositionSummary info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryPositionSummary(swigCPtr, sessionID, errorCode, isLast, TapAPIPositionSummary.getCPtr(info));
  }

  public virtual void OnRtnPositionSummary(TapAPIPositionSummary info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnPositionSummary(swigCPtr, TapAPIPositionSummary.getCPtr(info));
  }

  public virtual void OnRtnPositionProfit(TapAPIPositionProfitNotice info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnPositionProfit(swigCPtr, TapAPIPositionProfitNotice.getCPtr(info));
  }

  public virtual void OnRspQryCurrency(uint sessionID, int errorCode, char isLast, TapAPICurrencyInfo info) {
    TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryCurrency(swigCPtr, sessionID, errorCode, isLast, TapAPICurrencyInfo.getCPtr(info));
  }

  public virtual void OnRspQryTradeMessage(uint sessionID, int errorCode, char isLast, TapAPITradeMessage info) {
    if (SwigDerivedClassHasMethod("OnRspQryTradeMessage", swigMethodTypes30)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryTradeMessageSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPITradeMessage.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryTradeMessage(swigCPtr, sessionID, errorCode, isLast, TapAPITradeMessage.getCPtr(info));
  }

  public virtual void OnRtnTradeMessage(TapAPITradeMessage info) {
    if (SwigDerivedClassHasMethod("OnRtnTradeMessage", swigMethodTypes31)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnTradeMessageSwigExplicitITapTradeAPINotify(swigCPtr, TapAPITradeMessage.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnTradeMessage(swigCPtr, TapAPITradeMessage.getCPtr(info));
  }

  public virtual void OnRspQryHisOrder(uint sessionID, int errorCode, char isLast, TapAPIHisOrderQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRspQryHisOrder", swigMethodTypes32)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryHisOrderSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPIHisOrderQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryHisOrder(swigCPtr, sessionID, errorCode, isLast, TapAPIHisOrderQryRsp.getCPtr(info));
  }

  public virtual void OnRspQryHisOrderProcess(uint sessionID, int errorCode, char isLast, TapAPIHisOrderQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRspQryHisOrderProcess", swigMethodTypes33)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryHisOrderProcessSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPIHisOrderQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryHisOrderProcess(swigCPtr, sessionID, errorCode, isLast, TapAPIHisOrderQryRsp.getCPtr(info));
  }

  public virtual void OnRspQryHisMatch(uint sessionID, int errorCode, char isLast, TapAPIHisMatchQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRspQryHisMatch", swigMethodTypes34)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryHisMatchSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPIHisMatchQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryHisMatch(swigCPtr, sessionID, errorCode, isLast, TapAPIHisMatchQryRsp.getCPtr(info));
  }

  public virtual void OnRspQryHisPosition(uint sessionID, int errorCode, char isLast, TapAPIHisPositionQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRspQryHisPosition", swigMethodTypes35)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryHisPositionSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPIHisPositionQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryHisPosition(swigCPtr, sessionID, errorCode, isLast, TapAPIHisPositionQryRsp.getCPtr(info));
  }

  public virtual void OnRspQryHisDelivery(uint sessionID, int errorCode, char isLast, TapAPIHisDeliveryQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRspQryHisDelivery", swigMethodTypes36)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryHisDeliverySwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPIHisDeliveryQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryHisDelivery(swigCPtr, sessionID, errorCode, isLast, TapAPIHisDeliveryQryRsp.getCPtr(info));
  }
  ...
  public virtual void OnRspQryAccountCashAdjust(uint sessionID, int errorCode, char isLast, TapAPIAccountCashAdjustQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRspQryAccountCashAdjust", swigMethodTypes37)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryAccountCashAdjustSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPIAccountCashAdjustQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryAccountCashAdjust(swigCPtr, sessionID, errorCode, isLast, TapAPIAccountCashAdjustQryRsp.getCPtr(info));
  }

  public virtual void OnRspQryBill(uint sessionID, int errorCode, char isLast, TapAPIBillQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRspQryBill", swigMethodTypes38)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryBillSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPIBillQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryBill(swigCPtr, sessionID, errorCode, isLast, TapAPIBillQryRsp.getCPtr(info));
  }

  public virtual void OnRspQryAccountFeeRent(uint sessionID, int errorCode, char isLast, TapAPIAccountFeeRentQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRspQryAccountFeeRent", swigMethodTypes39)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryAccountFeeRentSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPIAccountFeeRentQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryAccountFeeRent(swigCPtr, sessionID, errorCode, isLast, TapAPIAccountFeeRentQryRsp.getCPtr(info));
  }
  ...
  public virtual void OnRspQryAccountMarginRent(uint sessionID, int errorCode, char isLast, TapAPIAccountMarginRentQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRspQryAccountMarginRent", swigMethodTypes40)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryAccountMarginRentSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPIAccountMarginRentQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryAccountMarginRent(swigCPtr, sessionID, errorCode, isLast, TapAPIAccountMarginRentQryRsp.getCPtr(info));
  }

  public virtual void OnRspHKMarketOrderInsert(uint sessionID, int errorCode, TapAPIOrderMarketInsertRsp info) {
    if (SwigDerivedClassHasMethod("OnRspHKMarketOrderInsert", swigMethodTypes41)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspHKMarketOrderInsertSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, TapAPIOrderMarketInsertRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspHKMarketOrderInsert(swigCPtr, sessionID, errorCode, TapAPIOrderMarketInsertRsp.getCPtr(info));
  }

  public virtual void OnRspHKMarketOrderDelete(uint sessionID, int errorCode, TapAPIOrderMarketInsertRsp info) {
    if (SwigDerivedClassHasMethod("OnRspHKMarketOrderDelete", swigMethodTypes42)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspHKMarketOrderDeleteSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, TapAPIOrderMarketInsertRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspHKMarketOrderDelete(swigCPtr, sessionID, errorCode, TapAPIOrderMarketInsertRsp.getCPtr(info));
  }

  public virtual void OnHKMarketQuoteNotice(TapAPIOrderQuoteMarketNotice info) {
    if (SwigDerivedClassHasMethod("OnHKMarketQuoteNotice", swigMethodTypes43)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnHKMarketQuoteNoticeSwigExplicitITapTradeAPINotify(swigCPtr, TapAPIOrderQuoteMarketNotice.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnHKMarketQuoteNotice(swigCPtr, TapAPIOrderQuoteMarketNotice.getCPtr(info));
  }

  public virtual void OnRspOrderLocalRemove(uint sessionID, int errorCode, TapAPIOrderLocalRemoveRsp info) {
    if (SwigDerivedClassHasMethod("OnRspOrderLocalRemove", swigMethodTypes44)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspOrderLocalRemoveSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, TapAPIOrderLocalRemoveRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspOrderLocalRemove(swigCPtr, sessionID, errorCode, TapAPIOrderLocalRemoveRsp.getCPtr(info));
  }

  public virtual void OnRspOrderLocalInput(uint sessionID, int errorCode, TapAPIOrderInfo info) {
    if (SwigDerivedClassHasMethod("OnRspOrderLocalInput", swigMethodTypes45)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspOrderLocalInputSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, TapAPIOrderInfo.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspOrderLocalInput(swigCPtr, sessionID, errorCode, TapAPIOrderInfo.getCPtr(info));
  }

  public virtual void OnRspOrderLocalModify(uint sessionID, int errorCode, TapAPIOrderInfo info) {
    if (SwigDerivedClassHasMethod("OnRspOrderLocalModify", swigMethodTypes46)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspOrderLocalModifySwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, TapAPIOrderInfo.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspOrderLocalModify(swigCPtr, sessionID, errorCode, TapAPIOrderInfo.getCPtr(info));
  }

  public virtual void OnRspOrderLocalTransfer(uint sessionID, int errorCode, TapAPIOrderInfo info) {
    if (SwigDerivedClassHasMethod("OnRspOrderLocalTransfer", swigMethodTypes47)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspOrderLocalTransferSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, TapAPIOrderInfo.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspOrderLocalTransfer(swigCPtr, sessionID, errorCode, TapAPIOrderInfo.getCPtr(info));
  }

  public virtual void OnRspFillLocalInput(uint sessionID, int errorCode, TapAPIFillLocalInputReq info) {
    if (SwigDerivedClassHasMethod("OnRspFillLocalInput", swigMethodTypes48)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspFillLocalInputSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, TapAPIFillLocalInputReq.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspFillLocalInput(swigCPtr, sessionID, errorCode, TapAPIFillLocalInputReq.getCPtr(info));
  }

  public virtual void OnRspFillLocalRemove(uint sessionID, int errorCode, TapAPIFillLocalRemoveReq info) {
    if (SwigDerivedClassHasMethod("OnRspFillLocalRemove", swigMethodTypes49)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspFillLocalRemoveSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, TapAPIFillLocalRemoveReq.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspFillLocalRemove(swigCPtr, sessionID, errorCode, TapAPIFillLocalRemoveReq.getCPtr(info));
  }

  public virtual void OnRspQrySpotLock(uint sessionID, int errorCode, char isLast, TapAPISpotLockDataRsp info) {
    if (SwigDerivedClassHasMethod("OnRspQrySpotLock", swigMethodTypes50)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQrySpotLockSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPISpotLockDataRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQrySpotLock(swigCPtr, sessionID, errorCode, isLast, TapAPISpotLockDataRsp.getCPtr(info));
  }

  public virtual void OnRtnSpotLock(TapAPISpotLockDataRsp info) {
    if (SwigDerivedClassHasMethod("OnRtnSpotLock", swigMethodTypes51)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnSpotLockSwigExplicitITapTradeAPINotify(swigCPtr, TapAPISpotLockDataRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnSpotLock(swigCPtr, TapAPISpotLockDataRsp.getCPtr(info));
  }

  public virtual void OnRspSubmitUserLoginInfo(uint sessionID, int errorCode, char isLast, TapAPISubmitUserLoginRspInfo info) {
    if (SwigDerivedClassHasMethod("OnRspSubmitUserLoginInfo", swigMethodTypes52)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspSubmitUserLoginInfoSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPISubmitUserLoginRspInfo.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspSubmitUserLoginInfo(swigCPtr, sessionID, errorCode, isLast, TapAPISubmitUserLoginRspInfo.getCPtr(info));
  }

  public virtual void OnRspSpecialOrderAction(uint sessionID, int errorCode, TapAPISpecialOrderInfo info) {
    if (SwigDerivedClassHasMethod("OnRspSpecialOrderAction", swigMethodTypes53)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspSpecialOrderActionSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, TapAPISpecialOrderInfo.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspSpecialOrderAction(swigCPtr, sessionID, errorCode, TapAPISpecialOrderInfo.getCPtr(info));
  }

  public virtual void OnRtnSpecialOrder(TapAPISpecialOrderInfo info) {
    if (SwigDerivedClassHasMethod("OnRtnSpecialOrder", swigMethodTypes54)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnSpecialOrderSwigExplicitITapTradeAPINotify(swigCPtr, TapAPISpecialOrderInfo.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnSpecialOrder(swigCPtr, TapAPISpecialOrderInfo.getCPtr(info));
  }

  public virtual void OnRspQrySpecialOrder(uint sessionID, int errorCode, char isLast, TapAPISpecialOrderInfo info) {
    if (SwigDerivedClassHasMethod("OnRspQrySpecialOrder", swigMethodTypes55)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQrySpecialOrderSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPISpecialOrderInfo.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQrySpecialOrder(swigCPtr, sessionID, errorCode, isLast, TapAPISpecialOrderInfo.getCPtr(info));
  }

  public virtual void OnRspQryCombinePosition(uint sessionID, int errorCode, char isLast, TapAPICombinePositionInfo info) {
    if (SwigDerivedClassHasMethod("OnRspQryCombinePosition", swigMethodTypes56)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryCombinePositionSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPICombinePositionInfo.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryCombinePosition(swigCPtr, sessionID, errorCode, isLast, TapAPICombinePositionInfo.getCPtr(info));
  }

  public virtual void OnRtnCombinePosition(TapAPICombinePositionInfo info) {
    if (SwigDerivedClassHasMethod("OnRtnCombinePosition", swigMethodTypes57)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnCombinePositionSwigExplicitITapTradeAPINotify(swigCPtr, TapAPICombinePositionInfo.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnCombinePosition(swigCPtr, TapAPICombinePositionInfo.getCPtr(info));
  }

  public virtual void OnRspQryUserTrustDevice(uint sessionID, int errorCode, char isLast, TapAPIUserTrustDeviceQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRspQryUserTrustDevice", swigMethodTypes58)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryUserTrustDeviceSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPIUserTrustDeviceQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryUserTrustDevice(swigCPtr, sessionID, errorCode, isLast, TapAPIUserTrustDeviceQryRsp.getCPtr(info));
  }

  public virtual void OnRspAddUserTrustDevice(uint sessionID, int errorCode, TapAPIUserTrustDeviceQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRspAddUserTrustDevice", swigMethodTypes59)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspAddUserTrustDeviceSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, TapAPIUserTrustDeviceQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspAddUserTrustDevice(swigCPtr, sessionID, errorCode, TapAPIUserTrustDeviceQryRsp.getCPtr(info));
  }

  public virtual void OnRspDelUserTrustDevice(uint sessionID, int errorCode, TapAPIUserTrustDeviceDelReq info) {
    if (SwigDerivedClassHasMethod("OnRspDelUserTrustDevice", swigMethodTypes60)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspDelUserTrustDeviceSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, TapAPIUserTrustDeviceDelReq.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspDelUserTrustDevice(swigCPtr, sessionID, errorCode, TapAPIUserTrustDeviceDelReq.getCPtr(info));
  }

  public virtual void OnRtnAddUserTrustDevice(TapAPIUserTrustDeviceQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRtnAddUserTrustDevice", swigMethodTypes61)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnAddUserTrustDeviceSwigExplicitITapTradeAPINotify(swigCPtr, TapAPIUserTrustDeviceQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnAddUserTrustDevice(swigCPtr, TapAPIUserTrustDeviceQryRsp.getCPtr(info));
  }

  public virtual void OnRtnDelUserTrustDevice(TapAPIUserTrustDeviceDelReq info) {
    if (SwigDerivedClassHasMethod("OnRtnDelUserTrustDevice", swigMethodTypes62)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnDelUserTrustDeviceSwigExplicitITapTradeAPINotify(swigCPtr, TapAPIUserTrustDeviceDelReq.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnDelUserTrustDevice(swigCPtr, TapAPIUserTrustDeviceDelReq.getCPtr(info));
  }

  public virtual void OnRspQryIPOInfo(uint sessionID, int errorCode, char isLast, TapAPIIPOInfoQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRspQryIPOInfo", swigMethodTypes63)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryIPOInfoSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPIIPOInfoQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryIPOInfo(swigCPtr, sessionID, errorCode, isLast, TapAPIIPOInfoQryRsp.getCPtr(info));
  }

  public virtual void OnRspQryIPOStockQty(uint sessionID, int errorCode, char isLast, TapAPIAvailableApplyQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRspQryIPOStockQty", swigMethodTypes64)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryIPOStockQtySwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPIAvailableApplyQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryIPOStockQty(swigCPtr, sessionID, errorCode, isLast, TapAPIAvailableApplyQryRsp.getCPtr(info));
  }

  public virtual void OnRspQryAccountIPO(uint sessionID, int errorCode, char isLast, TapAPIAccountIPOQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRspQryAccountIPO", swigMethodTypes65)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryAccountIPOSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, isLast, TapAPIAccountIPOQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspQryAccountIPO(swigCPtr, sessionID, errorCode, isLast, TapAPIAccountIPOQryRsp.getCPtr(info));
  }

  public virtual void OnRspAddAccountIPO(uint sessionID, int errorCode, TapAPIAccountIPOQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRspAddAccountIPO", swigMethodTypes66)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspAddAccountIPOSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, TapAPIAccountIPOQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspAddAccountIPO(swigCPtr, sessionID, errorCode, TapAPIAccountIPOQryRsp.getCPtr(info));
  }

  public virtual void OnRspCancelAccountIPO(uint sessionID, int errorCode, TapAPIAccountIPOQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRspCancelAccountIPO", swigMethodTypes67)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspCancelAccountIPOSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode, TapAPIAccountIPOQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspCancelAccountIPO(swigCPtr, sessionID, errorCode, TapAPIAccountIPOQryRsp.getCPtr(info));
  }

  public virtual void OnRtnAddAccountIPO(TapAPIAccountIPOQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRtnAddAccountIPO", swigMethodTypes68)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnAddAccountIPOSwigExplicitITapTradeAPINotify(swigCPtr, TapAPIAccountIPOQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnAddAccountIPO(swigCPtr, TapAPIAccountIPOQryRsp.getCPtr(info));
  }

  public virtual void OnRtnCancelAccountIPO(TapAPIAccountIPOQryRsp info) {
    if (SwigDerivedClassHasMethod("OnRtnCancelAccountIPO", swigMethodTypes69)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnCancelAccountIPOSwigExplicitITapTradeAPINotify(swigCPtr, TapAPIAccountIPOQryRsp.getCPtr(info)); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRtnCancelAccountIPO(swigCPtr, TapAPIAccountIPOQryRsp.getCPtr(info));
  }

  public virtual void OnRspUnFreezeVerificate(uint sessionID, int errorCode) {
    if (SwigDerivedClassHasMethod("OnRspUnFreezeVerificate", swigMethodTypes70)) TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspUnFreezeVerificateSwigExplicitITapTradeAPINotify(swigCPtr, sessionID, errorCode); else TapTradeAPIWrapperPINVOKE.ITapTradeAPINotify_OnRspUnFreezeVerificate(swigCPtr, sessionID, errorCode);
  }

  public ITapTradeAPINotify() : this(TapTradeAPIWrapperPINVOKE.new_ITapTradeAPINotify(), true) {
    SwigDirectorConnect();
  }
